    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Filter Service</b></h2>
                    </div><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Filter Service</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
						...
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <label class="sr-only">Person Required</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">~</div>
                                </div>
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Recently Added Service</h4>
