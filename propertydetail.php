    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Service Detail</b></h2>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            ...
                            <h5 class="mt-5 mb-4 text-secondary">Service Summary</h5>
                    ...
                    <div class="col-lg-4">
                        ...
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            <label class="sr-only">Service Amount</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">$</div>
                                </div>
                                <input type="text" class="form-control" name="amount" placeholder="Service Price">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="Duration ">
                            </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="interest" placeholder=" Person required">
                            </div>
                            <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4">Calclute Instalment</button>
                        </form>
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-5">Featured Services</h4>
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Recently Added Services</h4>
                            <ul class="property_list_widget">
