...
<head>
        ...
        <title>Call My city - Dashboard</title>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'apartment'";
										...
										<h6 class="text-muted">No. of Service Provider</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'house'";
										...
										<h6 class="text-muted">No. of Agents</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'building'";
										...
										<h6 class="text-muted">No. of Services Available</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'flat'";
										...
										<h6 class="text-muted">No. of Agent</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where stype = 'rent'";
										...
										<h6 class="text-muted">Monthly base </h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
