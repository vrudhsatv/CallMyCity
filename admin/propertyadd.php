...
<head>
        ...
        <title>Call my city | Services</title>
								...
								<div class="card-body">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Service Type</label>
													<div class="col-lg-9">
														<select class="form-control" required name="ptype">
															<option value="">Select Type</option>
															<option value="apartment">Hair Services for women</option>
															<option value="flat">Hair Services for men</option>
															<option value="building">Cleaning and Pest control</option>
															<option value="house">Electrician</option>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="stype">
															...
															<option value="rent">Rent Basis</option>
															<option value="sale">Monthly Basis</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Select Your Plan</label>
													<div class="col-lg-9">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<select class="form-control" id="">
														<option value="day">Select your Availability</option>
											...
											<div class="col-xl-6">
												<div class="form-group row mb-3">
													<label class="col-lg-3 col-form-label">Packages</label>
													<div class="col-lg-9">
														<select class="form-control" required name="bhk">
															<option value="">Select Package</option>
															<option value="1 BHK">Haircut for Men(Hair cut + Grooming+ massage)</option>
															<option value="2 BHK">Haircut for Women(Hair care + Facial cleanup+ Manicure/pedicure)</option>
															<option value="3 BHK"> Home Appliances Repair</option>
															<option value="4 BHK">Acquire Electrician/Carpenter/Plumber</option>
															<option value="5 BHK">Home Painting(Full/Semi)</option>
															<option value="1,2 BHK">Washing(House/Car/Bike)</option>
															<option value="2,3 BHK">Painting(Full/Semi)</option>
															<option value="2,3,4 BHK">House Keeper</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">People Required</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="bed" required placeholder="Enter No of people required (only no 1 to 10)">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Toolkit Required</label>
													<div class="col-lg-9">
														
														<input type="text" class="form-control" name="balc" required placeholder="Yes or No">
													</div>
													
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Offer Available</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="hall" required placeholder="Yes or No">
													</div>
												</div>
										...
										<div class="row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="floor">
															...
															<option value="1st Floor">User</option>
															<option value="2nd Floor">Agent</option>
															<option value="3rd Floor">Service Provider</option>
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
													<input type="text" class="form-control" name="state" required placeholder="Enter Your Contact no">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Area (locality)</label>
													<div class="col-lg-9">
										...
										<div class="form-group row">
											...
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												...
												<!--<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Service Recommendation : </span>Yes</li>
										...
										<div class="row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control"  required name="status">
															...
															<option value="sold out">Currently not </option>
														</select>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label"> Premium Plan Image</label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Gold Plan Image</label>
													<div class="col-lg-9">
