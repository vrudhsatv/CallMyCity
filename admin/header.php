						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="userbuilder.php"> Service Provider </a></li>
								</ul>
							</li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-map"></i> <span> Service</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="propertyadd.php"> Add Service</a></li>
									<li><a href="propertyview.php"> View Service </a></li>
