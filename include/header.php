                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>7895519003</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>callmycity@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="property.php">Services</a> </li>
									...
									<a class="btn btn-success d-none d-xl-block" style="border-radius:30px;" href="submitproperty.php">Submit Services</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
