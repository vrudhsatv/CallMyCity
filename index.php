...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/banericon.png'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">Your Service </span><br>
                            At your Home</h1><!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="type">
												...
												<option value="apartment"> Services for women</option>
												<option value="flat"> Services for men</option>
												<option value="building">Cleaning and Pest control</option>
												<option value="house">Electrician/plumber/carpenter</option>
												<option value="villa">Washing</option>
                                    ...
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="stype">
												...
												<option value="sale">On Demand</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-success w-100">Search Services</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We provide your services at your place as per your availability and convenience..</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Hire  Service Provider</a></h5>
                                <p>We allow you to hire  a service provider that match your expectations...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-list text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Service Listing</a></h5>
                                <p>We allow you to become  a service provider  that matchs your competencies...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Serve & Earn</a></h5>
                                <p>Our app allow you to serve and earn ...</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Recent Services</h2>
                    </div>
                    <!--- <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Searching</h5>
                            <p>At foremost first step is to search for a service provider .</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Listing </h5>
                            <p>Make a listing of service provider or services you want to have.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Appoint</h5>
                            <p>Appoint your service provider as per your availability.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Service Available</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Service Provider Available</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Rent Services Available</div>
                            </div>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Popular Services</h2></div>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    ...
                                    <span><?php 
												$total = $row[0];
												echo $total;?> Favourite Services </span> </div>
									<?php } ?>
                            </div>
                        </div><!-- FOR MORE PROJECTS visit: codeastro.com -->
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    ...
                                    <span><?php 
												$total = $row[0];
												echo $total;?> Services Listed</span> </div>
									<?php } ?>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 pb-1"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    ...
                                    <span><?php 
												$total = $row[0];
												echo $total;?>  Most liked Service </span> </div>
									<?php } ?>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    ...
                                    <span><?php 
												$total = $row[0];
												echo $total;?>  Favourite Provider</span> </div>
									<?php } ?>
                            </div>
                        </div><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    </div>
